...
// textures
var texP1 = new THREE.Texture();
var texP2 = new THREE.Texture();
...
function main() {
	...
	//var r1 = new THREE.WebGLRenderTarget(OFFSCREEN_SIZE, OFFSCREEN_SIZE);
	//var r2 = new THREE.WebGLRenderTarget(OFFSCREEN_SIZE, OFFSCREEN_SIZE);
	...
	var animate = function () {
		...
		//for (let i = 0; i < recursions; i++) {
			...
			texP1 = texPortal1.texture.clone();
			texP2 = texPortal2.texture.clone();
			portal1.material = new THREE.MeshBasicMaterial({ color: 0xffffff, map: texP1 });
			portal2.material = new THREE.MeshBasicMaterial({ color: 0xffffff, map: texP2 });
	
			//renderer.setRenderTarget(r1);
			//renderer.render(scene, cameraP2);
			//renderer.setRenderTarget(r2);
			//renderer.render(scene, cameraP1);
			//portal1.material = new THREE.MeshBasicMaterial({ color: 0xffffff, map: r1.texture });
			//portal2.material = new THREE.MeshBasicMaterial({ color: 0xffffff, map: r2.texture });
		//}
